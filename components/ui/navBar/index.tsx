    ...
    return (
        <>
            ...
            `}
                        ...
                        <NavBarLink href="/users" title="Usuarios"/>
                        <NavBarLink href="/envios" title="Envios"/>
    ...
    return (
        <li role="none" className="flex items-stretch">
            <Link
                role="menuitem"
                aria-haspopup="false"
                className={`flex items-center gap-2 py-4 transition-colors duration-300 focus:text-emerald-600 focus:outline-none focus-visible:outline-none lg:px-8'
                    ${
                        router.asPath === href
